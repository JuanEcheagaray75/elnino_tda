...
%     \texttt{A00827756@tec.mx}
%     \and
%     Juan Pablo Echeagaray González\\
%     \texttt{A00830646@tec.mx}
%     \and
%     Emily Rebeca Méndez Cruz\\
%     \texttt{A00830768@tec.mx}
%     \and
%     Eugenio Morales Ortiz\\
%     \texttt{A01734612@tec.mx}
%     \and
%     Mario Javier Soriano Aguilera\\
%     \texttt{A01384282@tec.mx}
% }

\author{Francisco Castorena Salazar}
\author{Juan Pablo Echeagaray González}
\author{Emily Rebeca Méndez Cruz}
\author{José Eugenio Morales Ortiz}
\author{Mario Javier Soriano Aguilera}
\affil{Ing. en Ciencias de Datos y Matemáticas, Tec de Monterrey}

\title{Planeación del Proyecto}
